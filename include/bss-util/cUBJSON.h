...
namespace bss_util {
  ...
  struct UBJSONValue : variant<cStr, bool, uint8_t, int8_t, int16_t, int32_t, int64_t, float, double, cDynArray<UBJSONValue, size_t, CARRAY_SAFE>, cDynArray<std::pair<cStr, UBJSONValue>, size_t, CARRAY_SAFE>, cDynArray<unsigned char, size_t>>
  {
    ...
    typedef variant<cStr, bool, uint8_t, int8_t, int16_t, int32_t, int64_t, float, double, UBJSONArray, UBJSONObject, UBJSONBinary> BASE;
  ...
  struct WriteUBJSONInternal<UBJSONValue, false>
  {
    static void F(const UBJSONValue& obj, std::ostream& s, char ty)
    {
      ...
      case UBJSONValue::Type<int8_t>::value: WriteUBJSON<int8_t>(obj.get<int8_t>(), s, ty); break;
